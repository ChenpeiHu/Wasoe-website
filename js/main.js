...
var SendMail = function () {
    ...
    /*//Fix for service hover text fade in/out
    jQuery('.service-content-holder a').hover(function () {
        jQuery(this).find('.service-no-hover-content').fadeOut( 0, () => {
            jQuery(this).find('.service-hover-content').fadeIn( 0 );
        });
    }, function () {
        jQuery(this).find('.service-hover-content').fadeOut( 0, () => {
            jQuery(this).find('.service-no-hover-content').fadeIn( 0 );
        });
    });*/

jQuery('.service-content-holder a').hover(function () {
    jQuery(this).find('.service-no-hover-content').delay(10).fadeOut( 0 );
    jQuery(this).find('.service-hover-content').delay(12).fadeIn( 0 );

}, function () {
    jQuery(this).find('.service-hover-content').delay(10).fadeOut( 0 );
    jQuery(this).find('.service-no-hover-content').delay(12).fadeIn( 0 );
